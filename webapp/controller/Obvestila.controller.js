sap.ui.define([
    ...
    "use strict";
    return Controller.extend("sap.ui.demo.wt.controller.Obvestila", {
        onInit : function () {
            ...
            sap.ui.core.UIComponent.getRouterFor(this).getRoute("Obvestila").attachPatternMatched(this.onRouteMatched, this);
        },
        ...
        addNotification: function(oEvent){
            //TODO
        }
    });
 });